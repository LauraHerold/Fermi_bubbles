...
def get_popescu(field):
    ...
    if 0:
        f0 = interpolate.interp1d(data[0], data[1], kind='linear')
        xs = np.linspace(data[0][0], data[0][-1], 100)
        f1 = interpolate.interp1d(xs, f0(xs), kind='linear',
