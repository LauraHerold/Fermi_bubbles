...
########################################################################################################################## Fit powerlaw
        ...
        if fit_plaw:
             ...
             if cutoff:
                 m = Minuit(chi2, N_zero = N_zero, error_N_zero = 0.00001, Gamma = 0.5, error_Gamma = 0.1, E_cut = 1., limit_E_cut = (0,1.e20), error_E_cut = 10., errordef = 1.)
                 m.migrad()
...
########################################################################################################################## Fit IC and/or pi0
        ...
        if fit_IC:
            ...
            if cutoff:
                m_IC = Minuit(chi2, N_0 = 1.e+12, n= -2.5, E_cut = 1., error_N_0 = 1000., limit_E_cut = (0.,1.e20), error_n = 1., error_E_cut = 100., errordef = 10.)
                m_IC.migrad()
        ...
        if fit_pi0:
            ...
            if cutoff:
                m_pi0 = Minuit(chi2, N_0 = 1.e+10, n= -2., E_cut = 1., limit_E_cut = (0.,1.e20), error_N_0 = 1000., error_n = 0.1, error_E_cut = 100., errordef = 1.)
                m_pi0.migrad()
