...
p_p = 10.**np.arange(-0.5, 8., 0.1)                                                     # Proton-momenta array (GeV)
...
########################################################################################################################## Fit spectra
    ...
    if fit_IC:
        ...
        dct = {"x" : Es[fitmin:fitmax]}
        N_0, gamma, Ecut_inv = 0.5e-12, 1., 0.
...
#right:
#above 1 GeV: E_tot_e =  3.82688033656e-14  erg/cm^3, E_tot_p =  6.55627839697e-13  erg/cm^3

#new above 1 GeV: E_tot_e =  6.2788775211e-15  erg/cm^3, E_tot_p =  2.46720874059e-13  erg/cm^3
