...
if source_class:
    map_fn = '../../data/P8_P302_Source_z100_w009_w478/maps'
    counts_fn = '../../data/P8_P302_Source_z100_w009_w478/maps'
    dct_fn ='dct/dct_lowE_source.yaml'
else:
    ...
    dct_fn ='dct/dct_lowE_ultraclean.yaml'
