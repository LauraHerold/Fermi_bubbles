...
fn_ending = '.pdf'
colours = ['black', 'grey', 'blue', 'dodgerblue', 'red', 'indianred', 'green', 'mediumseagreen']
linestyle = ['-', ':', '-', ':', '-', ':', '-', ':', '-', ':', '-', ':']
markers = ['s', 's', 'o', 'o', '>', '>', '<', '<']
markersize = [6,4,6,4,6,4,6,4,6,4]
ylimmax = [1e-4, 1e-4, 1e-4, 1e-4, 1e-4, 1e-4]
...
########################################################################################################################## plot energy flux with error bars
            ...
            label = input + r', $\ell \in (%i^\circ$' % (Lc[l] - dL/2) + r', $%i^\circ)$' % (Lc[l] + dL/2)
