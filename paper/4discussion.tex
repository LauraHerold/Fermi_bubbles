...
\begin{table*}
  \begin{center}
    ...
    \dima{The values 180 and 360 in the last two columns look strange.}}
    \label{tab:param}
    \begin{tabular}{|c|c|c|c|c|c|c|c|} % <-- Alignments: 1st column left, 2nd middle and 3rd right, with vertical lines in between
		...
		& $(\ang{-10}, \ang{0})$ & 2.0  & 2.2 & -- & 0.0 & 180 & 180  \\ 
 		\hline
  		$(\ang{-2}, \ang{2})$ & $(\ang{0}, \ang{10})$  & 3.5  & 2.3 & -- & 0.0 & 140 & 2.4  \\ 
		& $(\ang{-10}, \ang{0})$  & 6.4  & 2.1 & -- & 0.0 & 360 & 360   \\ 
 		\hline
  		$(\ang{-6}, \ang{-2})$ & $(\ang{0}, \ang{10})$  & 1.8  & 2.1 & 260 & 3.8 & 120 & 11  \\ 
		& $(\ang{-10}, \ang{0})$ & 2.8  & 2.2 & -- & 0.0 & 180 & 180 \\ 
 \hline
    \end{tabular}
  \end{center}
\end{table*}
