...
\begin{table*}
  \begin{center}
    ...
    \begin{tabular}{|c|c|c|c|c|c|c|c|} % <-- Alignments: 1st column left, 2nd middle and 3rd right, with vertical lines in between
		...
		& $(\ang{-10}, \ang{0})$ & 2.0  & 2.2 & \Laura{5.2e3} & 0.0 & 308 & {308}  \\ 
 		\hline
  		$(\ang{-2}, \ang{2})$ & $(\ang{0}, \ang{10})$  & 3.5  & 2.3 & \Laura{8.3e3} & 0.0 & {210} & 2.4  \\ 
		& $(\ang{-10}, \ang{0})$  & 6.4  & 2.1 & \Laura{8.3e6} & 0.0 & {350} & {350}   \\ 
 		\hline
  		$(\ang{-6}, \ang{-2})$ & $(\ang{0}, \ang{10})$  & 1.8  & 2.1 & 260 & 3.8 & 120 & 11  \\ 
		& $(\ang{-10}, \ang{0})$ & 2.8  & 2.2 &  \Laura{77e3} & 0.0 & {330} & {330} \\ 
 \hline
    \end{tabular}
  \end{center}
\end{table*}
