...
we fit a log-parabola to \red{the residual flux} in each latitude stripe
...
\caption{
\red{Index of the log-parabola defined in Equation (\ref{eq:log_par}) at  $E = \SI{500}{GeV}$ as a function of latitude for residuals in 
...
total smoothed gamma-ray counts in different latitude stripes using \red{likelihood based on gamma distribution}.
