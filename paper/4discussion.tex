...
\begin{table*}
  \begin{center}
    ...
    \dima{Some numbers seem to be very different with and without the last data point, e.g., 2.4 (180) and 12 (130). I've marked the strange numbers in red.
    Also the 95\% cutoff values for the rectangles model without the last point seem to be higher in all cases, I'd expect that they would be almost always lower.}
    ...
    \begin{tabular}{|c|c|c|c|c|c|c|c|} % <-- Alignments: 1st column left, 2nd middle and 3rd right, with vertical lines in between
		...
		\hline
  		$(\ang{2}, \ang{6})$ & $(\ang{0}, \ang{10})$ & 1.9  & 1.9 & 45 (45)& 4.8 & 25 (25) & 25  (25)\\ 
		& $(\ang{-10}, \ang{0})$ & 2.0  & 2.2 & $-\ (690)$ \cmt{5.2e3} & $< 0.1$ \cmt{0.027} & {510 (210)} & {510} (210)  \\ 
 		\hline
  		$(\ang{-2}, \ang{2})$ & $(\ang{0}, \ang{10})$  & 3.5  & 2.3 & $-\ (610)$ \cmt{8.3e3} &  $< 0.1$ \cmt{0.010} & {300(180)}  & \red{2.4 (2.0)}  \\ 
		& $(\ang{-10}, \ang{0})$  & 6.4  & 2.1 & $-\ (1300)$ \cmt{8.3e6} &  $< 0.1$ \cmt{3.3e-5} & {{1000} (480)} & {1000}  (460)  \\ 
 		\hline
  		$(\ang{-6}, \ang{-2})$ & $(\ang{0}, \ang{10})$  & 1.8  & 2.1 & 260 (260) & 3.8 & 130 (130)& \red{2.3 (2.3)} \\ 
		& $(\ang{-10}, \ang{0})$ & 2.8  & 2.2 &  $-\ (780)$ \cmt{77e3} &  $< 0.1$ \cmt{0.020} & {560(290)}  & {560 (290)}  \\ 
 \hline
    \end{tabular}
  \end{center}
\end{table*}
  ...
  \begin{center}
    \caption{Rectangles model without last data point.}
        \begin{tabular}{|c|c|c|c|c|} % <-- Alignments: 1st column left, 2nd middle and 3rd right, with vertical lines in between
     	\hline
		 Lat & Lon  &  $E_{\rm cut}$ &   $E_{\rm cut, 95\%}$  & $E_{\rm cut, 95\%}^{\rm min}$\\ 
		       &        &  {\small $\SI{}{GeV}$ }& {\small  $\SI{}{GeV}$ } & {\small  $\SI{}{GeV}$ } \\ 
		\hline
  		$(\ang{2}, \ang{6})$ & $(\ang{0}, \ang{10})$ & 45 &25 & 25\\ 
		& $(\ang{-10}, \ang{0})$ & 690 & 210 & 210\\ 
 		\hline
  		$(\ang{-2}, \ang{2})$ & $(\ang{0}, \ang{10})$  & 610 & 180 & 2.0 \\ 
		& $(\ang{-10}, \ang{0})$    & 1.3e3 & 480 & 460\\ 
 		\hline
  		$(\ang{-6}, \ang{-2})$ & $(\ang{0}, \ang{10})$ & 260 & 130 & 2.3  \\ 
		& $(\ang{-10}, \ang{0})$  & 780 & 290 & 290\\ 
 \hline
    \end{tabular}
  \end{center}
\end{table*}
