...
\begin{figure*}[h]
\includegraphics[width=0.5\textwidth]{plots/Lon_profiles_LowE_source_range_1.pdf}
\includegraphics[width=0.5\textwidth]{plots/Lon_profiles_LowE_source_range_2.pdf}
...
%\begin{comment}
\includegraphics[width=0.5\textwidth]{plots/SED_boxes_source_4cutoff.pdf} \\
\includegraphics[width=0.5\textwidth]{plots/SED_boxes_source_0cutoff.pdf} \\
\includegraphics[width=0.5\textwidth]{plots/SED_boxes_source_-4cutoff.pdf}
%\end{comment}
