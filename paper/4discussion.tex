...
$\frac{\de n_{h\nu}}{\de E_{h\nu}}$ is the number density of ISRF photons,
...
\begin{comment}
    ...
    \end{subfigure}
\end{comment}
  	\caption{SED of the residual emission plus the rectangles model of the FBs in the latitude stripes $(\ang{2}, \ang{6})$, $(\ang{-2}, \ang{2})$ and $(\ang{-6}, \ang{-2})$ for negative (blue) and positive (red) longitudes. We compare the parametric model of the SED with the leptonic (Section \ref{sec:IC_model}) 
...
averaged over $\sim 200$ pc above and below the GC.
