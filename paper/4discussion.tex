...
The ISRF number density for starlight and IR photons is taken from GALPROP v54.1 \citep{2006ApJ...640L.155M}
assuming that the emission at the base of the FBs is near the GC.
%We further discuss the consequences of the uncertainty in the ISRF energy density in Section \ref{sec:GC_scenario}.
...
We find (Appendix \ref{app:ISRF}) that this uncertainty can lead to a factor $\sim$ 30 uncertainty in the overall
