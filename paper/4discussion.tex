...
\begin{table*}
  \begin{center}
    ...
    \begin{tabular}{|c|c|c|c|c|c|c|c|} % <-- Alignments: 1st column left, 2nd middle and 3rd right, with vertical lines in between
		...
		\hline
  		$(\ang{2}, \ang{6})$ & $(\ang{0}, \ang{10})$ & 1.9  & 1.9 & 45 & 4.8 & 25 (45) & 25 (25) \\ 
		& $(\ang{-10}, \ang{0})$ & 2.0  & 2.2 & $-$ \cmt{5.2e3} & $< 0.1$ \cmt{0.027} & {510 (690)} & {510} (210)  \\ 
 		\hline
  		$(\ang{-2}, \ang{2})$ & $(\ang{0}, \ang{10})$  & 3.5  & 2.3 & $-$ \cmt{8.3e3} &  $< 0.1$ \cmt{0.010} & {300} (690) & \red{2.4 (180)}  \\ 
		& $(\ang{-10}, \ang{0})$  & 6.4  & 2.1 & $-$ \cmt{8.3e6} &  $< 0.1$ \cmt{3.3e-5} & {{1000} (1300)} & {1000} (480)   \\ 
 		\hline
  		$(\ang{-6}, \ang{-2})$ & $(\ang{0}, \ang{10})$  & 1.8  & 2.1 & 260 & 3.8 & 130 (260) & \red{12 (130)} \\ 
		& $(\ang{-10}, \ang{0})$ & 2.8  & 2.2 &  $-$ \cmt{77e3} &  $< 0.1$ \cmt{0.020} & {560} (780) & {560} (290) \\ 
 \hline
    \end{tabular}
  \end{center}
\end{table*}
