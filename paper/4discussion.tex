...
Finally, we find the minimum among the 95\% confidence lower limits for all considered models
including the models in Appendix \ref{sec:lowE_syst}.
...
\begin{table*}
  \begin{center}
    ...
    \begin{tabular}{|c|c|c|c|c|c|c|c|} % <-- Alignments: 1st column left, 2nd middle and 3rd right, with vertical lines in between
		...
		\hline
  		$(\ang{2}, \ang{6})$ & $(\ang{0}, \ang{10})$ & $1.5^{+0.0}_{-0.0}$  & $1.9\pm 0.0$ & $45\pm 0.0$ & 4.8 & 25& 25\\ 
		& $(\ang{-10}, \ang{0})$ & $3.1^{+0.0}_{-0.0}$  & 2.2 & $-$ \cmt{5.2e3} & $< 0.1$ \cmt{0.027} & {510} & {510}  \\ 
 		\hline
