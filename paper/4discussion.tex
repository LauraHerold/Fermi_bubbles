...
\begin{table*}
  \begin{center}
    \caption{Parametric model of the FB (best fit values for the rectangles model, significance of the cutoff, 95\% confidence on cutoff statistical,
    and 95\% confidence -- minimum among the models.}
    \label{tab:param}
...
\left(E\frac{\de Q}{\de E}\right)_{\!\!\gamma,\IC}\! = c\int\!\! \int \left(\frac{\de n}{\de E}\right)_{\!\!\ISRF} \sigma_\IC\ \left(\frac{\de n}{\de E}\right)_{\!\!\el} \de E_\ISRF\, \de E_\el,
\ee
...
\begin{figure}[h]
\centering
 \includegraphics[width=0.5\textwidth]{plots/Summary_SED_b=0_l=-5.pdf}
 \includegraphics[width=0.5\textwidth]{plots/Summary_SED_b=0_l=5.pdf}
...
\begin{table*}
  \begin{center}
    \caption{Summary of the min and max models for the parametric, IC and hadronic models of the FB for $|b| < 2^\circ$ and $-10^\circ < \ell < 0^\circ$.}
    \label{tab:param}
    \begin{tabular}{|c|c|c|c|c|c|c|c|} % <-- Alignments: 1st column left, 2nd middle and 3rd right, with vertical lines in between
     	\hline
		 Model & Type  & norm & index & cutoff 95\% stat & cutoff 95\% min \\ 
		       &        &  ${\rm \frac{GeV}{cm^{2}\, s\, sr}}$ &  & {\rm TeV} & {\rm TeV}\\ 
		\hline
  		Parametric & max & 1.  & -2 &  5 & 1 \\ 
		& min & 1.  & -2 &  5 & 1  \\ 
 		\hline
  		IC & max & 1.  & -2 &  5 & 1 \\ 
		& min & 1.  & -2 &  5 & 1  \\ 
 		\hline
  		Hadronic & max & 1.  & -2 &  5 & 1 \\ 
		& min & 1.  & -2 &  5 & 1  \\ 
 \hline
    \end{tabular}
  \end{center}
