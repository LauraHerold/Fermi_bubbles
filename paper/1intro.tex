...
but in this case the difference of the fluxes would have a soft spectrum characteristic for the propagated CR,
...
We use the ``on-off'' technic is a preliminary check in a search for a population of freshly accelerated CR:
...
Consequently, provided that there is a tentative asymmetry in diffuse gamma-ray emission near the GC at high energies with a spectrum
