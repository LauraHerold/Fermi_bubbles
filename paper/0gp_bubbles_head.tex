...
% 5 {} token are mandatory
  ...
  % {} leave it empty if necessary  
   ...
   Previous analyses of the residual gamma-ray emission at the base of the FBs have tentatively shown an increased intensity of emission
   (relative to the FBs emission at high latitudes), a power-law spectrum without a cutoff up to 1 TeV energies, 
  ...
  % methods heading (mandatory)
   ...
   Since there are large uncertainties in the determination of the foreground and background Galactic gamma-ray emission towards the GC,
   ...
   in order to get robust estimates of the residual emission.
   }
  % results heading (mandatory)
   {We confirm that the residual gamma-ray emission at the base of the FBs is consistent with a single power law up to 1 TeV energies, 
   has larger intensity than the FBs emission at high latitudes, and is shifted to the west (negative longitudes) from the GC.
