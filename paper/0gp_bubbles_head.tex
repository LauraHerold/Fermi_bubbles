...
% 5 {} token are mandatory
  ...
  % {} leave it empty if necessary  
   ...
   Understanding the behavior of the FB near the Galactic plane may give a key to answer the question of their origin.
  ...
  % results heading (mandatory)
   ...
   it is shifted to the west (negative longitudes) from the GC, and has larger intensity than the FB emission at high latitudes.
