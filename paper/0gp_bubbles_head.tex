...
% 5 {} token are mandatory
  ...
  % {} leave it empty if necessary  
   ...
   Understanding the behavior of the bubbles near the Galactic plane is important clue to resolve the question of the origin of the bubbles.}
  ...
  % methods heading (mandatory)
   {We use several methods to separate the gamma-ray emission of the bubbles from the Galactic foreground diffuse emission and from the point sources.}
  % results heading (mandatory)
   ...
   The spectrum is consistent with a power law without a cutoff up to 1 TeV.}
