...
% 5 {} token are mandatory
  ...
  % results heading (mandatory)
   ...
   In the leptonic scenario, the necessary number of SNRs is a factor of a few more than in the hadronic scenario 
   in order to produce the required density of CR electrons.
   }
