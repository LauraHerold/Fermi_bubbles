...
% 5 {} token are mandatory
  ...
  % aims heading (mandatory)
   {We analyze 9 years of the \Fermi-LAT data to study the gamma-ray emission at the base of the FB.
   }
  % methods heading (mandatory)
   {We use several analysis methods to separate the possible gamma-ray emission of the bubbles 
   from the Galactic foreground diffuse emission and from point sources.}
