...
% 5 {} token are mandatory
  ...
  % {} leave it empty if necessary  
   ...
   Understanding the properties of the FBs near the Galactic plane may give a key to answer the question of their origin.
   Previous analyses of the gamma-ray emission at the base of the FBs, which remains after subtraction of Galactic foregrounds,
   have tentatively shown an increased intensity of emission relative to the FBs emission at high latitudes, 
   a power-law spectrum without a significant cutoff up to the energy of 1 TeV, 
  ...
  % methods heading (mandatory)
   ...
   we use several methods to derive Galactic gamma-ray diffuse emission components as well as the contribution from point sources
   in order to get robust estimates of the emission at the base of the FBs.
   }
  % results heading (mandatory)
   {We confirm that the residual gamma-ray emission at the base of the FBs is well described by a simple power law up to 1 TeV energies.
   The 95\% confidence lower limit on the cutoff energy is 300 -- 350 GeV.
   The emission has larger intensity than the FBs emission at high latitudes and is shifted to the west (negative longitudes) from the GC.
