...
so that ${\delta}/{\sqrt{2}}$ is half of the pixel diagonal (if it where a square), while $0\degr\!\!.5$ is comparable to 68\% containment
above $\approx 2$ GeV.
...
The energy fluxes of the models and residuals integrated for $E = 10 - \SI{100}{GeV}$ are shown in Fig. \ref{fig:Maps_Rectangles}.
...
with a radius of $\frac{\delta}{\sqrt{2}} + 1^\circ$,
