...
We separate the whole sky in latitude stripes of \red{$\ang{4}$ width} so that the Healpix pixels are assigned to stripes that contain the centers of the pixels.
...
\centering
 \includegraphics[width=0.32\textwidth]{plots/Mollweide_Boxes_model_03-10GeV_flux_source_range_1_log.pdf}
  \includegraphics[width=0.32\textwidth]{plots/Mollweide_Boxes_0p3-1GeV_flux_source_range_1.pdf}
 ...
 the rectangles model of the FBs, and 
 residuals plus the rectangles model of the FBs derived in Section \ref{sec:box_model}
