...
The CRp energy density within $|b| < 6^\circ$ in the rectangular model of the FBs (Section \ref{sec:Pion_model})  
...
\includegraphics[width=0.5\textwidth]{plots/Summary_electron_spectra_0.pdf}
	...
	CRe measured by AMS-02 \citep{2014PhRvL.113v1102A}, \Fermi-LAT \citep{2017PhRvD..95h2007A},
	and H.E.S.S. 
...
which at a distance of 1.4 kpc from Earth, corresponds to a radius of about 50 pc.
If a Cygnus-like region is responsible for the emission within $|b| < 6^\circ$ at the base of the FBs,
then such region should be at a distance of about 500 pc from Earth.
...
cocoon at a distance of $\sim 500\:{\rm pc} - 1.5 \:{\rm kpc}$ from Earth towards the GC.
