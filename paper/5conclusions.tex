...
for $|b| < 6^\circ$: $L = 1.1 \times 10^{37}\:{\rm erg\ s^{-1}}$.
...
\centering
 ...
 \caption{Comparison of the hadronic model of the residual gamma-ray emission towards the base of the FB
...
\centering
 ...
 \caption{
 Comparison of the min and max models of the residual flux at the base of the FB with the Cygnus cocoon spectrum. 
