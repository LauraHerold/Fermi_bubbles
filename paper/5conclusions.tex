...
We assume a spatially constant diffusion coefficient $D(E) = D_0\left(\frac{E}{\SI{1}{GeV}}\right)^\delta$ with 
...
\centering
 ...
 \caption{Comparison of the hadronic model of the residual plus FBs gamma-ray emission at the base of the FB
...
The authors would like to thank Anna Franckowiak, Stefan Funk, Tsunefumi Mizuno, and Andrew Strong for valuable comments and suggestions.
