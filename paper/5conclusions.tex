...
The total gamma-ray luminosity in this case can be estimated as \Laura{$L = 1.1 \times 10^{37}\:{\rm erg\ s^{-1}}$}
...
then the total gamma-ray luminosity is \Laura{$L = 10^{37}\ {\rm erg\ s^{-1}}$},
