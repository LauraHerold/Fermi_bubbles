...
The cooling time has a significant uncertainty due to the uncertainties in the ISRF near the GC, e.g., 
it can be more than an order of magnitude shorter for higher ISRF densities in the model of \cite{2017MNRAS.470.2539P}.
...
The presence of the hadronic production of gamma rays at the base of the FBs, without any sign of a cutoff up to gamma-ray energies of 1TeV,  
is important
...
If the ISRF energy density is an order of magnitude higher near the GC \citep{2017MNRAS.470.2539P}, than the ISRF assumed in the GALPROP model,
then CRe energy density can be an order of magnitude smaller, i.e., the required number of SNRs is about 300,
but the cooling time is also an order of magnitude shorter.
Thus the SNRs should have exploded in the past $\sim$ 20 thousand years.
In this scenario, the gamma-rays produced in interactions of CR protons with gas will be subdominant to the IC gamma rays.
...
\includegraphics[width=\twopic\textwidth]{plots/Summary_electron_spectra_0.pdf}
	...
	Uncertainties in ISRF energy density near the GC result in additional order of magnitude uncertainties in the CRe energy density.
	In particular, CRe energy density derived with the ISRF model of \cite{2017MNRAS.470.2539P} results in 
	a factor $\sim$ 20 smaller overall normalization (see Appendix \ref{app:ISRF} for details). 
...
The index of the CRe (CRp) spectrum is 2.5 -- 2.9 (2.0 -- 2.2).
...
If the ISRF energy density is an order of magnitude higher \citep{2017MNRAS.470.2539P} than the GALPROP ISRF,
than both the cooling time and the required energy density of CRe are an order of magnitude smaller than in the reference model,
