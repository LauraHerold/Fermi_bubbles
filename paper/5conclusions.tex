...
\dima{We can also put the total gamma-ray luminosity here}
...
The position of the hard and bright emission at the base of the FB can be at any location along the line of sight.
...
(the actual age of the system is determined by the confinement within the shell of the superbubble).
In this scenario,
...
We use different methods to construct the foreground diffuse gamma-ray emission and determine
...
has a higher intensity than the FB emission at high latitudes,
...
The emission can be explained with either a hadronic or a leptonic IC production of gamma-rays
with spectra consistent with a power law without a cutoff.
...
then the total gamma-ray luminosity is \dima{add luminosity as $L = 10^{x}\ {\rm erg\ s^{-1}}$},
...
For the GC scenario, the diffusive escape time and the electron cooling time is $\gtrsim 100$ kyr.
...
One can imagine a situation that the FB were inflated by a past superbubble created about 1 Myr ago
...
scenario from a different and more recent starburst / SNR episode at about the same location.
