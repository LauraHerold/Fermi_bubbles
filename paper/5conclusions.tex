...
The escape time for the protons (and also electrons) at $E > \SI{3}{TeV}$ is 
...
\be
T_{\rm esc} < \frac{\Delta h^2}{2 D(E)} \approx \SI{170}{kyr}.
\ee
...
\end{comment}
\dima{Discuss magnetic reconnection in accretion to Sgr A* \citep{2018arXiv180305556B}.
...
Since the local gas density is similar to the gas density at the GC \citep{2017ApJ...834...57M}, 
we only need to take into account for the hadronic model the quadratic decrease of the gamma-ray flux with the radius. Assuming, that the emission is generated by one SN, we find a distance of $\SI{300}{pc}$.
We can compare the flux from the low latitude bubbles with the emission of a known SNR, such as the Tycho SNR.
The SED of the Tycho SNR at 10 GeV is $E^2 {dF}/{dE} \approx 10^{-6}\: {\rm MeV\, cm^{-2} s^{-1}}$ \citep{2017ApJ...836...23A}.
...
For the leptonic model we use the local ISRF and calculate the IC emission as described in Section \ref{sec:IC_model}. Assuming one single SN we find a distance of $\SI{50}{pc}$. Such an SNR would be easily observed by radio and X-ray observations, 
even if we neglect the hadronic mechanism of gamma-ray production.

Another possibility is that the bright emission at the base of the FB is similar to the gamma-ray emission in the Cygnus region 
...
if averaged over a $2^\circ$ circle.
This is slightly larger than an intensity of $E^2 {dN}/{dE} \approx 6\times 10^{-6}\: {\rm GeV\, cm^{-2} s^{-1}sr^{-1}}$
at the base of the FB within $|b| < 2^\circ$ (Figure \ref{fig:SED_with_fits}).
Thus the bright gamma-ray emission at the base of the FB can be explained by a Cygnus-like 
superbubble at a distance of $\sim 1$ kpc from the Earth towards the GC.
